    ...
    return(
        <div className="notes__main-content">
            ...
            <div className="notes__content">
                ...
                <textarea placeholder="What happend today..." className="notes__textarea" value={body} onChange={ handleInputChange } name="body"></textarea>
                {
                    (note.url) &&
                    <div className="notes__image">
                        <img src={note.url} alt="image_cover"/>
                    </div>
                }
            </div>
